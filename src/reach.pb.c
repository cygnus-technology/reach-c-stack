...
PB_BIND(cr_ParameterNotifySetupRequest, cr_ParameterNotifySetupRequest, AUTO)


PB_BIND(cr_ParameterNotifySetupResponse, cr_ParameterNotifySetupResponse, AUTO)
