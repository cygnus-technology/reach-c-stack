...
#define __MESSAGE_UTIL_H__
  ...
  // None of these message utilities are required without logging.
    ...
    void message_util_log_ping_response(const cr_PingResponse *);
        ...
        void message_util_log_notify_setup_request(const cr_ParameterNotifySetupRequest *);
        void message_util_log_notify_setup_response(const cr_ParameterNotifySetupResponse *);
